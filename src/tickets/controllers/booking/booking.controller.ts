import { Body, Controller, Delete, HttpStatus, Param, ParseIntPipe, Post, Req, Res, UseGuards } from '@nestjs/common';
...
export class BookingController {
    ...
    async bookTicket(
      ...
      if (!user || !ticket || !trip || ticket.availTic <= 0) {
            ...
            const seatNum = Math.floor(Math.random() * availableTickets) + 1; // Generate a random seat number within the available range
